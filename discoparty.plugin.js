 ...
 * @name DiscoParty
 * @version 1.0.0
 * @description Over 200 motivational quotes to display every minute.
 * @author _meuti
 *  
 */
 ...
 module.exports = class DiscoParty{
...
"“Never give up, just go and do you” — delta_alpha (my Discord friend)",
"“Wake up, go ahead, follow the path to the light and never stop” — Square Guard (me, the creator of this plugin)",
...
BdApi.alert("Welcome!","Thanks for using my plugin DiscoParty. I'm working on fixes and updates.");
(function(){
    currentQuote = quotes[Math.floor(Math.random() * quotes.length)];
    BdApi.showToast(currentQuote, {type: "info", timeout: 7000});
